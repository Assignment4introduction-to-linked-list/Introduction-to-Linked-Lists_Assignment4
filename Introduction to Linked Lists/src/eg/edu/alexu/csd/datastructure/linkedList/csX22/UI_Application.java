		...
		try (Scanner s = new Scanner(System.in)) {
			...
			while (true) {
				...
				case 1:{
					...
					while(s.hasNextInt()) {
						CoEx[0]=s.nextInt();CoEx[1]=s.nextInt();
						l.add(CoEx);
					}
					Object[] terms=new Object[l.size()];
					terms=l.listToArr(l);
					p.setPolynomial(Vname1, (int[][]) terms);
					System.out.println("Polynomial "+Vname1+"is set");break;
					}
				case 2:{
					System.out.println("Insert the variable name: A, B, C or R ");
					Vname1 = s.next().charAt(0);
					System.out.println("Value in"+Vname1+":"+p.print(Vname1));break;
					}
				case 3 :{System.out.println("Insert the first variable name: A, B, C or R ");
					...
					System.out.println("the result of adding :"+p.print('R'));break;
					}
				case 4 :{
					...
					System.out.println("the result of Subtracting :"+p.print('R'));break;
					}
				case 5 :{
					System.out.println("Insert the first variable name: A, B, C or R ");
					Vname1=s.next().charAt(0);
					...
					System.out.println("the result of Multiplying :"+p.print('R'));break;
					}
				case 6:{
					System.out.println("Insert the variable name: A, B, C or R ");
					Vname1=s.next().charAt(0);
					...
					float x = s.nextFloat();
			        System.out.println("Value of "+Vname1+" when x = "+ x + "is"+p.evaluatePolynomial(Vname1,x));break;
					}
				case 7:{
					System.out.println("Insert the variable name: A, B, C or R ");
					Vname1=s.next().charAt(0);
